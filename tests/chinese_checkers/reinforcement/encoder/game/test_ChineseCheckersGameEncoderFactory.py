...
from chinese_checkers.reinforcement.encode.game import ChineseCheckersGameEncoderFactory
from chinese_checkers.reinforcement.encode import GridPositionTargetEncoder
...
from chinese_checkers.reinforcement.encode.move import MoveEncoderFactory
...
class TestChineseCheckersGameEncoderFactory(unittest.TestCase):
    ...
    def test_create_grid_position_250_encoder(self):
        ...
        self.assertEqual(encoder.max_moves, 250,
                         "Expected max_moves of 250 for 'grid_position_250' encode")
        self.assertEqual(encoder.board_size, self.board_size,
                         "Expected board size to match factory initialization for 'grid_position_250' encode")
    ...
    def test_create_grid_position_100_encoder(self):
        ...
        self.assertEqual(encoder.max_moves, 100,
                         "Expected max_moves of 100 for 'grid_position_100' encode")
        self.assertEqual(encoder.board_size, self.board_size,
                         "Expected board size to match factory initialization for 'grid_position_100' encode")
    ...
    def test_create_spatial_board_state_encoder(self):
        ...
        self.assertEqual(encoder.board_size, self.board_size,
                         "Expected board size to match factory initialization for 'spatial_board_state' encode")
    ...
    def test_create_spatial_board_metrics_encoder(self):
        ...
        self.assertEqual(encoder.board_size, self.board_size,
                         "Expected board size to match factory initialization for 'spatial_board_metrics' encode")
